...
async function processPosition(position: Position) {
  try {
    ...
    const tokenData: TokenData = {
      ...
      // Add missing required fields from interface
      bonusCategory: null,
      botDegenCount: 0,
      botDegenRate: 0,
      bundlerMhr: 0,
      ...
      completeTimestamp: 0,
      createdTimestamp: 0,
      createdTimestampUs: 0,
      creationTool: "",
      creator: "",
      creatorCreatedCount: 0,
      creatorCreatedOpenCount: 0,
      creatorCreatedOpenRatio: 0,
      devTeamHoldRate: 0,
      devTokenBurnAmount: 0,
      devTokenBurnRatio: 0,
      dexscrAd: false,
      dexscrBoostFee: 0,
      dexscrTrendingBar: false,
      dexscrUpdateLink: false,
      endLiveTimestamp: 0,
      entrapmentRatio: 0,
      exchange: "",
      feeParams: null,
      ...
      sellTax: 0,
      seqIndex: "",
      showSharingFee: false,
      sniperCount: 0,
      startLiveTimestamp: 0,
      status: 0,
      ...
      twitterDelPostTokenCount: 0,
      twitterDup: 0,
      twitterHandle: "",
      twitterIsTweet: false,
